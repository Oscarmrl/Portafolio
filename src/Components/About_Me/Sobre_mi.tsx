        ...
        <div className=" flex flex-col items-center md:flex-row w-5/6 gap-4">
          ...
          <div>
            ...
            <motion.h3
              ...
              className=" text-start text-2xl font-bold md:text-3xl text-base-content font-roboto mb-3 caret-transparent"
            >
              ¿Quién soy yo?
            </motion.h3>
            ...
            <motion.p
              ...
              whileInView={{ transform: "translateX(0px)" }}
              transition={{ type: "spring" }}
              className="text-start text-2xl font-roboto text-base-content/80 caret-transparent"
            >
